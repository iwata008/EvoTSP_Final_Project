(function evoTSPwrapper($) {
  ...
  */
  ...
  function runGeneration(generation, cb) {
    ...
    function wait5seconds(wait_cb) {
      ...
      setTimeout(function () {
        ...
        wait_cb(); // Call wait_cb() after the message to "move on" through the
        ↪ waterfall
      }, 5000);
    }
    ...
    function updateThresholdLimit(bestRoutes, utl_cb) {
      if (bestRoutes.length == 0) {
        const errorMessage = 'We got no best routes back. We probably overwhelmed
        ↪ the write capacity for the database.';
        alert(errorMessage);
  ...
  function getBestRoutes(generation, callback) {
    ...
    const generation = $('num-generations').val();
    var setting = {
  ...
  function displayRoute(result) {
    ...
    $('#new-route-list').append(`<li><b>We generated route</b> ${routeId} with len ${length}`);
  }
